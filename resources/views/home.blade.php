        ...
        <div class="grid gap-10">
            ...
            <section class="relative overflow-hidden rounded-3xl border border-slate-800
                ...
                <div class="relative grid gap-10 lg:grid-cols-[1.45fr_0.75fr] lg:items-center">
                    ...
                    <div class="relative">
                        <div class="rounded-2xl border border-slate-700/80
                                    bg-slate-950/80 p-5 shadow-xl shadow-black/30
                                    backdrop-blur">
                            ...
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <div class="mt-1 font-semibold text-slate-100">
                                        Everything your adventure needs
                                    </div>
                                </div>
                            ...
                            <div class="mt-5 grid grid-cols-2 gap-3">
                                ...
                                <div class="rounded-xl border border-slate-800 bg-slate-900/50 p-3">
                                    <div class="text-xs text-slate-500">Encounters</div>
                                    <div class="mt-1 text-sm font-medium text-slate-200">
                                        Manual & AI
                                    </div>
                                </div>
                                ...
                                <div class="rounded-xl border border-slate-800 bg-slate-900/50 p-3">
                                    <div class="text-xs text-slate-500">Dungeons</div>
                                    <div class="mt-1 text-sm font-medium text-slate-200">
                                        AI & Procedural
                                    </div>
                                </div>
                            ...
                            <div class="mt-3 rounded-xl border border-emerald-900/60
                                        bg-emerald-950/20 px-4 py-3">
                                <div class="flex items-center gap-2 text-xs font-medium text-emerald-300">
                                    <span>✦</span>
                                    Campaign AI Context
                                    <span class="ml-auto rounded-full border border-emerald-800
                                ...
                                <p class="mt-1 text-xs leading-5 text-slate-500">
                                    Generated content can stay aware of your campaign's
                                    characters, sessions, decisions, and unresolved hooks.
                                </p>
                            </div>
